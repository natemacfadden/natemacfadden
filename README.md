...
- **[latticepts](https://github.com/natemacfadden/latticepts)** — High-performance C/Cython implementation of Kannan's lattice point enumeration algorithm applied to general polyhedra. Outperforms Normaliz and OR-Tools CP-SAT with better scaling. Handles cases up to 75M+ lattice points.
