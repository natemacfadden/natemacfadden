...
- **[fanroots](https://github.com/natemacfadden/fanroots)** — Library for optimization over a certain class of piecewise-smooth landscapes with combinatorial transitions: the secondary fan of point/vector configurations. The particular task was in finding roots of vector-valued functions, like what is done in [Candidate de Sitter Vacua](https://arxiv.org/abs/2406.13751).
