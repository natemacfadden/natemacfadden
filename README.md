...
- **[latticepts](https://github.com/natemacfadden/latticepts)** — High-performance C/Cython implementation of Kannan's lattice point enumeration algorithm applied to polyhedra. Quicker than both Normaliz and OR-Tools CP-SAT, with better scaling. Can generate, for example, >100M lattice points in the strict interior of a certain 7D cone of interest in <30s.
