...
- **[latticepts](https://github.com/natemacfadden/latticepts)** — High-performance C/Cython implementation of Kannan's lattice point enumeration algorithm applied to general polyhedra. Outperforms Normaliz by ~8x in raw speed and continues enumerating 75M+ lattice points where Normaliz and OR-Tools CP-SAT both time out.
