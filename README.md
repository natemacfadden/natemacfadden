...
- **[repo-review](https://github.com/natemacfadden/repo-review)** - A Claude Code plugin for standing up your github repos and running them throguh a battery of tests. Can be run with just `/repo-review:review [ENTER REPO HERE]` which will spawn five sub-agents with different lenses (performance, correctness, engineering, taste & positioning, documentation), each analyzing your repo, running code, coming up with tests, profiling, etc. according to their lens.
