...
- **[NTFE algorithm](https://arxiv.org/abs/2309.10855)** — Simple combinatorial algorithm for triangulating reflexive polytopes with exponentially better scaling than previous methods; bounds on NTFE counts established in [this work](https://arxiv.org/abs/2602.16909). Implemented in [CYTools](https://github.com/LiamMcAllisterGroup/cytools).
- **[CYTools](https://github.com/LiamMcAllisterGroup/cytools)** — BDFL of the standard toolkit for studying Batyrevian CY compactifications in string theory. Contributions include:
  1. a generalization to vex triangulations via `regfans` (see next major item), and
...
- **[latticepts](https://github.com/natemacfadden/latticepts)** — C/Cython implementation of Kannan's lattice point enumeration algorithm for general polyhedra, outperforming OR-Tools and Normaliz in tested use-cases.
